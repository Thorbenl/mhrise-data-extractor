...
local quest_manage_type_definition = sdk.find_type_definition("snow.QuestManager");
local on_changed_game_status = quest_manage_type_definition:get_method("onChangedGameStatus");
